...
import { Form, Select, Icon, Transfer, Input, Card, TimePicker, Button, Radio } from 'antd';
          ...
          <Form onSubmit={this.handleSubmit} hideRequiredMark style={{ marginTop: 8 }}>
            ...
            <FormItem {...formItemLayout} label="测试域名">
              {getFieldDecorator('domain', {
                ...
                <Input
                  placeholder="请输入测试域名 .eg: https://app.xxx.com:8080"
                  value="http://192.168.11.206:8081"
                />
              )}
            </FormItem>
